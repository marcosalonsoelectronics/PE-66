// Automatically generated C++ file on Sun May  5 12:55:23 2024
//
// To build with Digital Mars C++ Compiler:
//
//    dmc -mn -WD controller1.cpp kernel32.lib
...
extern "C" __declspec(dllexport) void controller1(void **opaque, double t, union uData *data)
{
   ...
   double &out0 = data[7].d; // output
   double &out1 = data[8].d; // output
   double &out2 = data[9].d; // output
   double &out3 = data[10].d; // output
   double &out4 = data[11].d; // output
   double &out5 = data[12].d; // output
...
// out1, ramp output
            ...
            if ((in1+Ramp)>in2)             out0=0;  // turns off switch when current > peak current ref.
